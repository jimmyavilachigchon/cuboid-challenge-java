...
insert into "BAGS" ("ID", "TITLE", "VOLUME") values (1, 'Title 1', 20.0);
insert into "BAGS" ("ID", "TITLE", "VOLUME") values (2, 'Title 2', 30.0);
insert into "BAGS" ("ID", "TITLE", "VOLUME") values (3, 'Title', 100.0);
